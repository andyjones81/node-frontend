...
const sessionName = 'gc-frontend-' + (Buffer.from(config.serviceName, 'utf8')).toString('hex')
let sessionOptions = {
  secret: sessionName,
  cookie: {
...
console.log('Gambling Commission Frontend Boilerplate')
